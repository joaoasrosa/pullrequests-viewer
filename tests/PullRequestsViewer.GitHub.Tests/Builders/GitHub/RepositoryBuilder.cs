    ...
    internal static class RepositoryBuilder
    {
        internal static IReadOnlyList<Repository> GenerateValidRepositories()
        {
            return new[]
            {
                ...
                new Repository(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, 2,
                    new User(), "Bar", string.Empty, string.Empty, string.Empty, string.Empty, true, false, 1, 1, string.Empty, 1,
                    null, DateTimeOffset.Now, DateTimeOffset.Now, null, null, null, true, true, true, true, 1, 1, null, null, null)
            };
        }
